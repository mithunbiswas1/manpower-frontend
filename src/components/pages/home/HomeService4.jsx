        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {services.map(({ id, title, imageUrl, link }) => (
            ...
            >
              ...
              <div className="w-full h-0 group-hover:h-full bg-black/30 text-white rounded-lg transition-all duration-500 ease-in-out transform origin-bottom group-hover:rotate-x-0"></div>
              <div className="absolute inset-0 m-4 flex items-end justify-center overflow-hidden">
                <div className="w-full h-0 group-hover:h-3/5 bg-black/70 text-white rounded-lg p-4 transition-all duration-500 ease-in-out transform origin-bottom rotate-x-90 group-hover:rotate-x-0">
                  ...
                  <div className="absolute inset-0 flex">
                    ...
                    {/* Horizontal line */}
                    <div className="absolute w-2/4 bottom-14 h-0.5 bg-primary opacity-0 group-hover:opacity-100 transition-all duration-500 " />
                  </div>

                  {/* Title */}
                  <h3 className="absolute text-xl opacity-0 group-hover:opacity-100 group-hover:text-2xl font-semibold z-10 text-right bottom-10 right-10 transition-all duration-300 ml-20 ">
                    {title}
                  </h3>
                </div>
              </div>
